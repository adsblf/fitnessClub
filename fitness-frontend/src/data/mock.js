...
export const clientUpcomingBookings = [
  { id: 1, class: "Йога (утро)",   date: "2026-04-02", time: "09:00", trainer: "Анна Соколова",  hall: "Зал №2", status: "ПОДТВЕРЖДЕНО" },
  { id: 2, class: "Пилатес",       date: "2026-04-04", time: "11:00", trainer: "Мария Блинова",  hall: "Зал №2", status: "ЗАБРОНИРОВАНО" },
  { id: 3, class: "Растяжка",      date: "2026-04-07", time: "19:30", trainer: "Анна Соколова",  hall: "Зал №3", status: "ЗАБРОНИРОВАНО" },
];

export const clientVisitHistory = [
  { id: 1, class: "Йога",       date: "2026-03-28", time: "09:00", trainer: "Анна Соколова",  status: "ПОСЕЩЕНО" },
  { id: 2, class: "Пилатес",    date: "2026-03-25", time: "11:00", trainer: "Мария Блинова",  status: "ПОСЕЩЕНО" },
  { id: 3, class: "Кроссфит",   date: "2026-03-21", time: "10:00", trainer: "Дмитрий Козлов", status: "НЕЯВКА" },
  { id: 4, class: "Силовая",    date: "2026-03-18", time: "18:00", trainer: "Игорь Петров",   status: "ПОСЕЩЕНО" },
  { id: 5, class: "Йога",       date: "2026-03-14", time: "09:00", trainer: "Анна Соколова",  status: "ПОСЕЩЕНО" },
];
